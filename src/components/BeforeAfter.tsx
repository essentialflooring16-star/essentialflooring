...
export default function BeforeAfter({ beforeSrc, afterSrc, beforeAlt, afterAlt }: Props) {
  ...
  return (
    <div
      ref={ref}
      className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl select-none shadow-lift touch-pan-y has-[:focus-visible]:ring-4 has-[:focus-visible]:ring-oak has-[:focus-visible]:ring-offset-2"
      onPointerDown={(e) => {
