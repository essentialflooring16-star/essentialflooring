...
export const dashboard = {
  en: {
    ...
    'dashboard.stat_page_views': 'Page views',
    'dashboard.stat_unique_visits': 'Unique visits',
    'dashboard.stat_views_per_visit': 'Views per visit',
  ...
  ro: {
    ...
    'dashboard.stat_page_views': 'Vizualizări',
    'dashboard.stat_unique_visits': 'Vizite unice',
    'dashboard.stat_views_per_visit': 'Vizualizări pe vizită',
